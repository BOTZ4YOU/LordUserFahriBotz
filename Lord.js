...
module.exports = Zeeone = async (Zeeone, Ofc) => {
	try {
		...
		try {
					...
					pp_userb = 'https://i.ibb.co/J7cLV42/yoaimo.jpg'
				}
...
•> Jasa Sewa Bot By Fahri Store🥵🥴🤙🏻 

 *List Sewa??* 

┏━━⬣ 𝐏𝐫𝐢𝐜𝐞 𝐋𝐢𝐬𝐭 𝐎𝐧𝐞✨ 
┃💌 : SEWA 1.5K/MINGGU/GC (PROMO)
┃💌 : SEWA 3.5K/BLN/GC (PROMO
┃💌 : SEWA PERMANEN 5K (PROMO) 
┃💌 : SEWA PERMANEN 12K (NORMAL) 
┗━━⬣ _*🛍️Fahri Store🛍️*_
┏━━⬣ 𝐏𝐫𝐢𝐜𝐞 𝐋𝐢𝐬𝐭 𝐓𝐰𝐨🎋 
┃💌 : JADI BOT 15K/BLN
┃💌 : JADI BOT + OWNER 35K 
...
┃💌 : ==========================
┃💌 : ==========================
┃💌 : Mo ngtes Bot? Nih Linknya : 👇🏻
┃💌 : https://bit.ly/3cG7cgH
┃💌 : ==========================
┃💌 : ==========================
┃💌 : Link Gc BOT?🤖👇🏻
┃💌 : https://bit.ly/30OySO9
┃💌 : ==========================
┃💌 : ==========================
...
┏━━⬣ *Payment Digital??* ♨️ 
┃📌 : *Gopay👇🏻* 
┃📝 : _Qris (Scan PP Saya) A/N F********e_
┃💌 : ==========================
┃📌 : *Ovo👇🏻*
┃📝 : _085772674695 A/N F********e_ 
┃💌 : ==========================
┃📌 : *Dana👇🏻* 
┃📝 : _085772674695 A/N F********e_
┃💌 : ==========================
┃📌 : *Qris All Payment*
┃📝 :  _Minta Ke Owner Saja_
┃💌 : ==========================
┗━━⬣ _*🛍️Fahri Store🛍️*_

┏━━⬣ *Payment Non Digital♨️??*
┃📌 : *Pulsa (Indosat/my IM3)+5k👇🏻*
┃📝 :  _085772674695_
┃💌 : ==========================
┃📌 : *Pulsa (Smartfren)+5k👇🏻*
┃📝 :  _088905703349_
...
┏━━⬣ *Minat??Chat Aja Kak😁*
┃💌 : *[Note :Promo Abis??Blik Ke Normal]*
┃💌 : *List Normal??👇🏻* 
┃📌 : _Per Minggu/gc = 3k_   
┃📌 : _Perbulan/gc = 7k_  
┃📌 : _Permanen/gc = 12k_
┃💌 : *Sistem??👇🏻*
┃📌 :  _Bot msuk-jdiin admin-tf-ss bkti-done_
┃📌 : _Tf-ss bkti-Bot msuk-jdiin admin-done_
┗━━⬣ _*🛍️Fahri Store🛍️*_
...
┏━━⬣ _*🛍️Fahri Store🛍️*_
┃💌 : Mau Booking?Chat Aja,Asal jngn PHP!!
┃💌 : PHP??,Blok + Hpus Daftar list Yang 
┃mau Booking Bot Gua!!
┃💌 : Mau Ngetes Bot?Chat Wa Ini!
┃[Note : Jngn spam Bot!!,Ktauan sma Own?
┃Blok!!]
┗━━⬣ _*🛍️Fahri Store🛍️*_
...
Minat? Pm wa.me/${owner_number}`,
	    ...
	    const ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net",   "remoteJid": "62857726746954-1604595598@g.us"  }, "message": {orderMessage: {itemCount: 2021,status: 200, thumbnail: thumbnail, surface: 200, message: `「 𝐑𝐔𝐍𝐓𝐈𝐌𝐄 」\n${runtime2}`, orderTitle: 'FahriBotz', sellerJid: '0@s.whatsapp.net'}}, sendEphemeral: true}
...
Pastikan Transfer Limit Benar`)
						...
						case 'buyprem': case 'beliprem':
									if (isPremium) return reply('Loe Dah Prem Cuy_-')
...
Alasan : ${reason}`, [sender], true)
						...
						case 'setnamagrup': case 'setnamegrup': case 'setgrupname':
									...
									if (!isGroupAdmins && !isOwner) return reply(mess.only.admin)
									if (!isBotGroupAdmins) return reply(`Jadikan Bot Sebagai Admin Group!`)
									if (args.length == 0) return reply(`Penggunaan ${prefix + command} FahriBotz Support`)
...
*🔖 Url : ${vrr.display_url}*`
						...
						case 'bc': case 'broadcast':
									if (!Ofc.key.fromMe && !isOwner) return reply(mess.only.owner) 
									if (args.length < 1) return reply(`${prefix + command} FahriBotz`)
          ...
          reply('reply sticker/audio')
					...
					break
						...
						case 'stickermeme': case 'memesticker': case 'memestick': case 'stickmeme': case 'stcmeme': case 'smeme':
									if (!isPremium && !Ofc.key.fromMe) return reply(mess.only.prem)
									try {
										if (!q) return reply(`${prefix+command} Fahri|Botz`)
